...
public class JwtService {
    ...
    private static final String SECRET_KEY = "2113fad4a7c7c5d9d1df07435a6e8ab4e25467946898e2a6d73ab5994cb1d17a";
    ...
    public String generateToken(Map<String, Object> extraClaims, UserDetails userDetails){
        return Jwts.builder().setClaims(extraClaims)
                ...
                .setExpiration(new Date(System.currentTimeMillis() + 1000 * 60 * 60))   // 1 hora de duracion el token
